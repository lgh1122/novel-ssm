...
public class AppUpdateController {
	...
	public CheckUpdateInfo findNewAppVersion() {
		...
		// 
	    mCheckUpdateInfo.setIsForceUpdate(0);//设置是否强制更新,该方法的参数只要和服务端商定好什么数字代表强制更新即可
		mCheckUpdateInfo.setNewAppReleaseTime("2018-06-20 12:37");//软件发布时间
		mCheckUpdateInfo.setNewAppSize(4.3f);//单位为M
		mCheckUpdateInfo.setNewAppUrl("https://novel01-1252454126.cos.ap-beijing.myqcloud.com/%E9%83%BD%E9%82%A6%E6%B0%B4%E5%8D%B0%E7%9B%B8%E6%9C%BA_v2.1_2.apk");
